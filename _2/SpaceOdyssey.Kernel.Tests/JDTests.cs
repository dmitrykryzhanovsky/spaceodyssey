...
namespace SpaceOdyssey.Tests
{
    ...
    public class JDTests
    {
        ...
        [TestMethod ()]
        public void GetJDTest_Midnight ()
        {
            int year     = 2023;
            int month    = 7;
            int day      = 12;
            ...
            double actual = JD.GetJD (year, month, day, hour, min, sec, millisec, ECalendarStyle.Gregorian);

            Assert.AreEqual (expected, actual);
        }

        [TestMethod ()]
        public void GetJDTest_OneMillisecondBeforeNoon ()
        {
            int year     = 2023;
            int month    = 7;
            int day      = 12;
        ...
        [TestMethod ()]
        public void GetJDTest_OneMillisecondAfterNoon ()
        {
            int year     = 2023;
            int month    = 7;
            int day      = 12;
        ...
        [TestMethod ()]
        public void GetJDTest_OneMillisecondBeforeMidnight ()
        {
            int year     = 2023;
            int month    = 7;
            int day      = 12;
