...
namespace SpaceOdyssey
{
    ...
    /// </para>
    /// <para>
    ///     Момент времени T, для которого происходит вычисление наклона земной оси, во всех методах задаётся количеством юлианских 
    ///     столетий, прошедших от эпохи J2000 до интересующего нас момента времени. Если интересующий нас момент времени 
    ///     предшествовал эпохе J2000, значение T будет отрицательным.
    /// </para>
    /// <para>
    ...
    {
        /// <summary>
        /// 23°23′ в секундах – это наклон земной оси с точностью до минуты для эпохи J2000. Все вычисления в данном классе нужны для 
        /// определения наклона земной оси с точностью до секунды и её долей.
        /// </summary>
        ...
        {
            return InitialApproximation + Polynomial.ComputeCube (T, ArcsecondSeries_DE200);
        }
        ...
        {
            return InitialApproximation + Polynomial.Compute (T, ArcsecondSeries_P03);
        }
        ...
        {
            return InitialApproximation + Polynomial.Compute (T / 100.0, ArcsecondSeries_Laskar);
        }
    }
}