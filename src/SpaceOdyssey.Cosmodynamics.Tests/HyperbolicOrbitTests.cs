...
namespace SpaceOdyssey.Cosmodynamics.Tests
{
    ...
    public class HyperbolicOrbitTests
    {
        ...
        public void CreateByRPeriapsisTest ()
        {
            ...
            HyperbolicOrbit orbit = HyperbolicOrbit.CreateByRPeriapsis (center, orbiting, rp, e, t0);
        ...
        [TestMethod ()]
        public void CreateByRPeriapsisTest_Exception_E1 ()
        {
            Mass   center   = Mass.CreateByMass (10.0);
            Mass   orbiting = Mass.ZeroMass;
            double rp       = 1.38;
        ...
        [TestMethod ()]
        public void CreateByRPeriapsisTest_Exception_ELess1 ()
        {
            Mass   center   = Mass.CreateByMass (10.0);
            Mass   orbiting = Mass.ZeroMass;
            double rp       = 1.38;
