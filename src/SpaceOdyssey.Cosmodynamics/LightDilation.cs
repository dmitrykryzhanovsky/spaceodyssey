...
namespace SpaceOdyssey.Cosmodynamics
{
    public static class LightDilation
    {
        ...
        /// <param name="sattelitePosition">Положение спутника (наблюдаемого теле) в глобальной системе координат.</param>
        /// <param name="satteliteVelocity">Скорость спутника (наблюдаемого теле) в глобальной системе координат.</param>
