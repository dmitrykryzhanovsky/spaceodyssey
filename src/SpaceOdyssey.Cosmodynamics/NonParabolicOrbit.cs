namespace SpaceOdyssey.Cosmodynamics
{
    public abstract class NonParabolicOrbit : KeplerOrbit
    {
        ...
        protected virtual void ComputeAuxiliary ()
        {
            _aux1pe = 1.0 + _e;
            _aux1me = 1.0 - _e;
        }

        protected virtual void ComputeShapeByRPE ()
        {
            _a = Formulae.Shape.NonParabola.SemiMajorAxisByRP (_rp, _aux1me);
            _p = Formulae.Shape.NonParabola.FocalParameterByRP (_rp, _aux1pe);
        }

        protected virtual void ComputeMotionByRPE ()
        {
        ...
        protected virtual void ComputeMotionInvariants ()
        {
